    ...
    var MapService = /** @class */ (function () {
        ...
        MapService.prototype.addMarker = function (marker) {
            ...
            if (marker.markersEvents.dragStart.observers.length) {
                markerInstance.on('dragstart', function (event) { return _this.zone.run(function () { return marker.markersEvents.dragStart.emit(event.target); }); });
            }
            if (marker.markersEvents.drag.observers.length) {
                markerInstance.on('drag', function (event) { return _this.zone.run(function () { return marker.markersEvents.drag.emit(event.target); }); });
            }
            if (marker.markersEvents.dragEnd.observers.length) {
                markerInstance.on('dragend', function (event) { return _this.zone.run(function () { return marker.markersEvents.dragEnd.emit(event.target); }); });
            }
        ...
        MapService.prototype.createPopup = function (popup, element) {
            var _this = this;
            return this.zone.runOutsideAngular(function () {
                Object.keys(popup.popupOptions).forEach(function (key) { return popup.popupOptions[key] === undefined && delete popup.popupOptions[key]; });
        ...
        MapService.prototype.createMap = function (options) {
            ...
            var subChanges = this.zone.onMicrotaskEmpty.subscribe(function () { return _this.applyChanges(); });
        ...
        MapService.prototype.findLayersBySourceId = function (sourceId) {
            ...
            return layers.filter(function (l) { return l.source === sourceId; });
        };
        MapService.prototype.hookEvents = function (events) {
            ...
            if (events.error.observers.length) {
                this.mapInstance.on('error', function (evt) { return _this.zone.run(function () { return events.error.emit(evt); }); });
            }
    ...
    var GeolocateControlDirective = /** @class */ (function () {
        ...
        GeolocateControlDirective.prototype.ngAfterContentInit = function () {
            ...
            this.MapService.mapCreated$.subscribe(function () {
                ...
                _this.ControlComponent.control.on('geolocate', function (data) { return _this.geolocate.emit(data); });
                _this.MapService.addControl(_this.ControlComponent.control, _this.ControlComponent.position);
            });
        };
    ...
    var DraggableDirective = /** @class */ (function () {
        ...
        DraggableDirective.prototype.handleDraggable = function (enter$, leave$, updateCoords) {
            ...
            this.MapService.mapCreated$.subscribe(function () {
                ...
                leave$
                    .pipe(operators.takeUntil(_this.destroyed$), operators.tap(function () { return (inside = false); }), operators.filter(function () { return !moving; }))
                    .subscribe(function () {
                    _this.MapService.changeCanvasCursor('');
                    _this.MapService.updateDragPan(true);
                });
        ...
        PopupComponent.prototype.addPopup = function (popup) {
            ...
            this.MapService.mapCreated$.subscribe(function () {
                if (_this.lngLat || _this.feature) {
                    _this.MapService.addPopupToMap(popup, _this.lngLat ? _this.lngLat : _this.feature.geometry.coordinates);
                }
